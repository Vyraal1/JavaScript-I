...
// are we allowed to use classes in this?
...
console.log("The name of the grandchild is " + parent.child.grandchild.name);
console.log("The age of the grandchild is " + parent.child.grandchild.age);
