...
function logCarInfo(num) {
  console.log(
    `Car ${inventory[num].id} is a ${inventory[num].car_year} ${
      inventory[num].car_make
    } ${inventory[num].car_model}.`
  );
}
//gets the 33nd car info
logCarInfo(32);

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
logCarInfo(inventory.length - 1);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console

//using array sort function as I think using other sort methods seem overkill this early on in the course
function sortCarArray(arr) {
  return arr.sort((a, b) => {
...
//assuming it means BMW OR Audi cars, because there isn't any car that is both BMW and Audi
let BMWAndAudi = [];
for (car of inventory) {
